...
class BaseModel(models.AbstractModel):
    ...
    def fields_view_get(self, view_id=None, view_type='form', toolbar=False, submenu=False):
        ...
        access_recs = self.env['access.domain.ah'].search([('access_management_id.user_ids','in',self.env.user.id),('model_id.model','=',res['model'])])
        delete = 'false'
        edit = 'false'
        create = 'false'
        readonly = False
        ...
        if not readonly and access_recs:
            if view_type == 'form':
