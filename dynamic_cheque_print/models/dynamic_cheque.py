...
class dynamic_cheque_format_configuration(models.Model):
    ...
    # first signator
    font_size_first_signatory = fields.Float(string="First Signatory Font Size", default=5)
    first_signatory = fields.Char(string="Salutation of 1st Signatory",
                                  default="Authorize Signature ____________________")
    first_signatory_top_margin = fields.Float(string="First Signatory Top Margin", default=80)
    first_signatory_left_margin = fields.Float(string="First Signatory Left Margin", default=10)
    # second signator
    font_size_second_signatory = fields.Float(string="Second Signatory Font Size", default=5)
    ...
    second_signatory_left_margin = fields.Float(string="Second Signatory Left Margin", default=150)
    # third signator
...
class wizard_cheque_preview(models.TransientModel):
    ...
    def action_cheque_preview(self):
        ...
        data_str = data_str.replace('\\n', '')
        pdf_image = xml_id._run_wkhtmltopdf([str(data_str)], header=None, footer=None, landscape=None,
...
class wizard_dynamic_cheque_print(models.TransientModel):
    ...
    def action_call_report(self):
        ...
        return self.env.ref('dynamic_cheque_print.dynamic_cheque_print_report').report_action(self, data=datas)
